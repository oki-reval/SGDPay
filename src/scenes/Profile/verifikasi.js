...
class Verifikasi extends React.Component {
  ...
  toValidate = () => {
    ...
    if (user.nama_singkat == "") {
      ...
      this.setState({ ErrorNP: '', currentPage: 1 });
  ...
  toValidateV1 = () => {
    ...
    if (user.jenis_identitas == "") {
      ...
      this.setState({ ErrorNi: '', currentPage: 2 });
        ...
        <View style={{ flex: 1 }}>
          <ViewPager style={styles.PageView} scrollEnabled={false} initialPage={0} ref={(viewPager) => { this.viewPager = viewPager }}>
            <View key="1" style={{ flex: 1 }}>
              ...
              <View style={[style.shadow, { padding: 10, backgroundColor: '#fff' }]}>
                <ButtonGradient title='Selanjutnya' loading={loading} onPress={this.toValidate} />
              </View>
            </View>
            ...
            <View key="2" style={{ flex: 1 }}>
              ...
              <View style={[style.shadow, { padding: 10, backgroundColor: '#fff' }]}>
                <ButtonGradient title='Selanjutnya' loading={loading} onPress={this.toValidateV1} />
              </View>
            </View>
            ...
            <View>
              ...
              <View style={[style.shadow, { padding: 10, backgroundColor: '#fff' }]}>
                <ButtonGradient title='Selanjutnya' loading={loading} onPress={this.toCreRek} />
              </View>
            </View>
          </ViewPager>
        </View>
